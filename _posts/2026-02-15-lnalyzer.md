...
The extension is **completely private** — all monitoring happens locally in your browser, and no data is sent anywhere. It's also lightweight and open-source, so you can verify exactly what it does.
